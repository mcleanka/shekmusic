...
<br> <br>
<h2 class='text-primary'>Upload Music Audio</h2>
				<legend></legend>
				...
				<form id= "upload_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" autocomplete="off" role="form">
					...
					<div class="form-group">
						<label for="file1" class="">Select Audio:</label><br>
					...
					<div class="form-group">
						<label for="title" class="">Audio Display Name:</label><br>
						<input type="text" name="title" class="form-control" id="title" required>
					</div>

						<div class="form-group">
						<label for="producer" class="">Audio Display Producer:</label><br>
						<input type="text" name="producer" class="form-control" id="producer" required>
					</div>

	<div class="form-group">
						<label for="genre" class="">Audio Genre:</label><br>
					...
					<div class="form-group">
						<label for="description" class="">Audio Description:</label><br>
						<textarea class="form-control" id="description" name="description" rows="4"></textarea>						
					</div>
					<div class="form-group">
						<label for="poster" class="">Choose a Audio Poster: </label><br>
				...
				<script type="text/javascript" src="js/audio_uploader.js"></script>						
