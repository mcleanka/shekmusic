...
function uploadFile(){
	...
	ajax.open( "POST" , "connections/parsers/video-uploader.php" ); 
	ajax.send(formdata); 
} 
...
function completeHandler(event){ 
	...
	$("#after_links").html("<a href='video_player.php?id="+event.target.responseText+"' class='btn btn-primary'>View Video</a><br><br><a href='video-upload.php' class='btn btn-info'>Upload Another</a>");
