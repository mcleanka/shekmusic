...
function uploadFile(){
	...
	ajax.open( "POST" , "connections/parsers/news-uploader.php" ); 
	ajax.send(formdata); 
} 
...
function completeHandler(event){ 
	...
	$("#after_links").html("<a href='../watch-news.php?id="+event.target.responseText+"' class='btn btn-success'>View Video</a><br><br><a href='news-upload.php' class='btn btn-primary'>Upload Another</a>");
