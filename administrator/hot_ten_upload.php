...
<br><br>
				<h2 style="color:#006699; text-shadow:1px 2px 2px">Upload Top Chart</h2>
				<legend></legend><br>
							...
							<div class="panel-body">
								<form id= "upload_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" autocomplete="off" role="form">
									...
									<div class="form-group">
										<label for="file" class="">Select Video:</label><br>
										<span class="btn btn-default btn-file col-sm-12 col-xs-12" style="border:1px #777 solid; border-radius:0;"><input type="file" name="file" id="file" class="btn-file col-sm-12 col-xs-12" onchange="changed()"  required/></span>
									</div>
									...
									<div class="form-group">
										...
										<div class="form-group">
										<label for="producer" class="">Video Display Producer:</label><br>
						...
						<select name="genre" id='genre' class="form-control" >
							...
							<option value="2" name="others">Others</option>
									...
									<div class="form-group">
										...
										<span class="btn btn-default btn-file col-sm-12 col-xs-12" style="border:1px #777 solid; border-radius:0;"><input type="file" name="poster" id="poster" class="btn-filecol-sm-12 col-xs-12" onchange="changed()" /></span>
									</div>
									<div class="form-group">
...
<script type="text/javascript" src="js/hot-ten-uploader.js"></script
</div>
<?php load_footer(); ?>