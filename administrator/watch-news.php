...
$res = $db->query("SELECT * FROM e_news WHERE id=$id");
...
<div class="main-content">
	<div class="wrap">
		<div class="left-sidebar" style="margin-top:10px;">				
			<?php// include("core/includes/categories.php");  ?>				
		</div>
...
<div class="right-content-heading-left">
					<h3 style="color:#555; width:640px;"><?php echo $cont; ?></h3>
				</div>
<div class="right-content-heading-left">
					<h3 style="color:#555; width:640px;"><?php echo $rep; ?></h3>
				</div>
				<div class="controls" style="width:640px;">
					<p>
						<?php $size = filesize($path)/1024/1024; if ($size <= 128): ?>
							<a style="margin-left:10px; width:100px;" class="btn btn-sm btn-success pull-right" href="download-video?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-download"></span> Download</a>
						<?php endif; ?>	 				
					</p>
