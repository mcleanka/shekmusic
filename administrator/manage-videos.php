...
?>
  ...
  <script type="text/javascript">
    ...
    if (r == true) {
      window.location.href="delete-video.php?id="+x;
    } 
  }
    function updateuser(y) {
    var r = confirm("Do you want to Play this Song...?");
    if (r == true) {
      window.location.href="watch-video.php?id="+y;
    } 
  }
</script>    
</div>
